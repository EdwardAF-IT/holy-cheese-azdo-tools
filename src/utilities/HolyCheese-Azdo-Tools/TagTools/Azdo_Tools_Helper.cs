...
namespace HolyCheese_Azdo_Tools.TagTools
{
    ...
    /// </summary>
    public class Azdo_Tools_Helper : IAzdo_Tools_Helper
    {
        ...
        /// </summary>
        public Azdo_Tools_Helper(ILoggerFactory loggerFactory, ITagDataProvider provider)
        {
        ...
        public async Task<string?> AddTag(int workItemId, string tag)
        {
            try
            {
                ...
                await _provider.PatchTags(workItemId, tags.Append(tag).ToArray(), hasTagsField);
                return null;
            }
