$sourceDir = "C:\Code\holy-cheese\holy-cheese-azdo-tools\src\HolyCheeseAzdoTools\TagTools\"
$testDir = "C:\Code\holy-cheese\holy-cheese-azdo-tools\tests\unit\HolyCheeseAzdoTools.UnitTests\TagTools\"
